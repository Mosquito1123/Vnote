...
//  VNote
//
//  Created by ccj on 2018/8/21.
//  Copyright © 2018年 ccj. All rights reserved.
//

#import "CJRightView.h"
@interface CJRightView()<UITableViewDelegate,UITableViewDataSource>
...
+(instancetype)xibRightView{
    CJRightView *view = [[[NSBundle mainBundle]loadNibNamed:@"CJRightView" owner:nil options:nil] lastObject];
