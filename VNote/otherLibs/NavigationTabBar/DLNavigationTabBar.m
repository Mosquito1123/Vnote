...
-(instancetype)initWithTitles:(NSArray *)titles normalTitleColor:(UIColor *)normalColor selectedTileColor:(UIColor *)selectColor
{
    if (self = [super initWithFrame:CGRectMake(0, 0, DL_ScreenWidth, 44)]) {
        self.buttonNormalTitleColor = normalColor;
        self.buttonSelectedTileColor = selectColor;
